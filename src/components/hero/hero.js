                ...
                <div className="row">
                    <div className="col-lg-7">
                        <div className="it_solution_hero_content" style={{ backgroundImage: `url(${Bg1})` }}>
                            <div className="heading_focus_text mb-0 d-inline-flex align-items-center">👋 Olá, nós somos <span className="badge bg-secondary text-white">Data Savvy</span></div>
                            <h1>
                                Faça o seu negócio crescer com Soluções de Tecnologia e TI
                            </h1>
                            <p>
                                No cenário empresarial competitivo de hoje, a demanda por soluções de TI eficientes e econômicas nunca foi tão crítica.
                            </p>
                                ...
                                <li>
                                    <div className="review_short_info">
                                        <div className="d-flex">
                                            <img src={icon} alt="Data Savvy - Avaliação Trustpilot" />
                                            <span>4.8</span>
                                        </div>
                    ...
                    <div className="col-lg-5">
                        <ul className="it_solution_hero_images unordered_list">
                            <li>
                                <img src={heroImg} alt="Data Savvy - Solução de TI - Hero" />
                            </li>
                            <li>
                                <div className="worldwide_clients">
                                    <div className="counter_value">150+</div>
                                    <p>
                                        Temos clientes em diversos países ao redor do mundo
                                    </p>
                                    <ul className="avatar_group unordered_list">
                                        <li>
                                            <img src={avatar1} alt="Data Savvy - Avatar" />
                                        </li>
                                        <li>
                                            <img src={avatar2} alt="Data Savvy - Avatar" />
                                        </li>
                                        <li>
                                            <img src={avatar3} alt="Data Savvy - Avatar" />
                                        </li>
                                        <li>
                                            5k+
                                        </li>
                                ...
                                <div className="business_growth_content" style={{ backgroundImage: `url(${Bg2})` }}>
                                    <div className="business_growth">
                                        <div className="progress_content">
                                            ...
                                            <p>
                                                Alcance 88% de melhoria nos serviços e crescimento empresarial
                                            </p>
                                        </div>
                                    </div>
                                </div>
