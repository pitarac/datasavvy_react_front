                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-lg-5">
                        <div className="business_consulting_hero_content">
                            <h1>
                                Estratégias Inovadoras de <mark><u>Crescimento</u></mark>
                            </h1>
                            <p>
                                Navegando o Caminho para o Sucesso: Consultoria Perspicaz para Negócios Prósperos
                            </p>
                            ...
                            <div className="google_reviews">
                                <div className="review_admin_logo">
                                    <img src={shape1} alt="Logo Google" />
                                </div>
                                <div className="review_info_content">
                                    ...
                                    <div className="review_counter">4.8 Avaliações no Google <b>(128 Avaliações)</b></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="business_consulting_hero_image">
                            <img className="hero_image" src={shape2} alt="Consultoria de Negócios" />
                            <div className="funfact_block capsule_layout wow fadeInUp" data-wow-delay=".1s">
                                <div className="funfact_content">
                                    ...
                                    <h3 className="funfact_title mb-0">Clientes Satisfeitos</h3>
                                </div>
                                <div className="funfact_icon">
                                    <img src={icon1} alt="Ícone de Usuário" />
                                </div>
                            </div>
                            <div className="funfact_block middle capsule_layout wow fadeInUp" data-wow-delay=".2s">
                                <div className="funfact_icon">
                                    <img src={icon2} alt="Ícone de Valor" />
                                </div>
                                <div className="funfact_content">
                            ...
                            <div className="funfact_block capsule_layout wow fadeInUp" data-wow-delay=".3s">
                                <div className="funfact_content pt-2 pb-1">
                                    <h3 className="funfact_title mb-0 text-center">Taxa de Sucesso</h3>
